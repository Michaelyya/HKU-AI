...
from layers import CustomConv2D, CustomCrossEntropyLoss, CustomMaxPool2D, CustomLinear

######################### 
# Do not change the hyper parameters Here
...
class SimpleCNN(nn.Module):
    ...
    def __init__(self, num_classes = 10):
        ...
        # self.conv1_custom = CustomConv2D(in_channels=1, out_channels=32, kernel_size=5)
        # self.conv2_custom = CustomConv2D(in_channels=32, out_channels=64, kernel_size=5)
